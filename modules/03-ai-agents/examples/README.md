...
| [`03_chat_with_github_repo.py`](03_chat_with_github_repo.py) | A read-only agent that answers questions about a public GitHub repo using the GitHub REST API (README, file listing/contents, issue search) - same loop, real-world tools |
